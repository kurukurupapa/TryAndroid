...
public class OAuthHelper {
    ...
    public OAuthHelper(MyActivity activity, Runnable okRunnable, Runnable ngRunnable) {
        mActivity = activity;
    ...
    private boolean setSelectedAccount() {
        ...
        mActivity.startActivityForResult(mCredential.newChooseAccountIntent(), MyActivity.REQUEST_CODE_ACCOUNT_PICKER);
    ...
    private void createDrive() {
        ...
        mDrive = new Drive.Builder(AndroidHttp.newCompatibleTransport(), new AndroidJsonFactory(), mCredential).setApplicationName(APP_NAME).build();
    ...
    private boolean auth() {
        ...
        mActivity.startActivityForResult(mUserRecoverableAuthIOException.getIntent(), MyActivity.REQUEST_CODE_AUTHORIZATION);
        mUserRecoverableAuthIOException = null;
