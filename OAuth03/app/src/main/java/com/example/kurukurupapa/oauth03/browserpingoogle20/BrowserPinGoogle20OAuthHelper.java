 ...
 */
public class BrowserPinGoogle20OAuthHelper {
    private static final String TAG = BrowserPinGoogle20OAuthHelper.class.getSimpleName();
    ...
    public BrowserPinGoogle20OAuthHelper(Context context, Runnable okRunnable) {
