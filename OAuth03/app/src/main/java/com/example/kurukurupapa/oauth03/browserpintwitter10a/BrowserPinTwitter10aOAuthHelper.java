...
public class BrowserPinTwitter10aOAuthHelper {
    private static final String TAG = BrowserPinTwitter10aOAuthHelper.class.getSimpleName();
    ...
    public BrowserPinTwitter10aOAuthHelper(Context context, Runnable okRunnable) {
