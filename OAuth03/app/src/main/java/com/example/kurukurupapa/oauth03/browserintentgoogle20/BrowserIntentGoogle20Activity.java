...
public class BrowserIntentGoogle20Activity extends Activity {
    private static final String TAG = BrowserIntentGoogle20Activity.class.getSimpleName();

    private BrowserIntentGoogle20OAuthHelper mOAuthHelper;
    private Uri mUri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_browser_intent_google20);

        mOAuthHelper = new BrowserIntentGoogle20OAuthHelper(this, new Runnable() {
            @Override
            public void run() {
                onOAuthOk();
            }
